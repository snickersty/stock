...
#print(si.get_data('DIA',end_date=today)['close'])
x_size = 8 # 横に表示する最大数
##### 初期設定　ここまで ##################
...
draw.text((x_width*x_size-200, 55),datetime.datetime.now(pytz.timezone('America/New_York')).strftime('前日比 '+"%Y/%m/%d %H:%M"),'black',font=font_cate)
